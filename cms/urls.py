...
urlpatterns = [
    ...
    path('userlink/', views.userAd, name='user-ad'),
    path('userlink/delete/', views.userAdDelete, name='ad-delete'),
    ...
    path('payment/', views.PaymentHomeView.as_view(), name='payment'),
    path('payment/', views.paymentConfig, name='pay_con'),
